...
//Tracker, put foods here
const fruits = [almondMilk, creamCheese, oatmeal, oatmeal, butter];
...
function Total(){
    ...
    document.getElementById("ECal").innerHTML = (['Calories:', Math.round(totalCalories * 100 + Number.EPSILON ) / 100, 'kcals'].join(' '));
    document.getElementById("ECarb").innerHTML = (['Carbohydrates:', Math.round(totalCarbs * 100 + Number.EPSILON ) / 100, 'g'].join(' '));
    document.getElementById("EProtein").innerHTML = (['Protein:', Math.round(totalProtein * 100 + Number.EPSILON ) / 100, 'g'].join(' '));
    document.getElementById("EFat").innerHTML = (['Fat:', Math.round(totalFat * 100 + Number.EPSILON ) / 100, 'g'].join(' '));
 };
Total();